...
功能：
1. 读取 configure.py 中的应用配置
2. 调用 application_profiler 进行剖析
3. 保存 JSON 结果
4. 处理 MPI 应用的特殊情况
5. 错误处理和日志记录
"""
...
class ApplicationProfiler:
    ...
    def __init__(self, app_name, output_json=None, pc_start=None, pc_end=None):
        ...
        self.log_file = os.path.join(LOGS_DIR, f"{app_name}_profile_{timestamp}.log")
...
示例:
  ...
  # 剖析并指定输出文件
  python profile_single.py bfs --output ./my_bfs_profile.json
